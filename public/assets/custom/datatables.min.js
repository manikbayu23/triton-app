 ...
 *   https://datatables.net/download/#bs5/dt-1.11.3/r-2.2.9/sl-1.3.3
 *
 * Included libraries:
...
(function (l) {
    ...
    u.ext = M = {
        buttons: {},
        classes: {},
        builder: "bs5/dt-1.11.3/r-2.2.9/sl-1.3.3",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (h) {
    ...
    function F(a) {
        ...
        h("body").on(
            ...
            function (g) {
                !c._select.blurable ||
                    h(g.target).parents().filter(a.table().container())
                        .length ||
