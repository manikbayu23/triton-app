<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <h1 class="font-semibold text-2xl text-dark">Admin</h1>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('list_program.index')" :active="request()->routeIs('list_program.index')">
                        {{ __('Program Belajar') }}
                    </x-nav-link>
                    ...
                    <div class="hidden sm:flex sm:items-center ">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('level.index')">
                                    {{ __('Level') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('room.index')">
                                    {{ __('Ruangan') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('time.index')">
                                    {{ __('Waktu') }}
                                </x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('list_program.index')" :active="request()->routeIs('list_program.index')">
                {{ __('Program Belajar') }}
            </x-responsive-nav-link>
